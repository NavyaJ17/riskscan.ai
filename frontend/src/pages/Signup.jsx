...
function Signup() {
  ...
  return (
    <div className=" min-h-screen min-w-screen sm:min-h-auto sm:border sm:p-10 sm:rounded-xl sm:min-w-2xl p-4 bg-gray-950 flex items-center justify-center outline outline-white/10">
      <div className="flex flex-col justify-center items-center w-full">
        ...
        >
          <div className="w-full">
            ...
            >
              <i className="flex justify-center items-center bi bi-person text-white/50 text-xl"></i>
              <input
          ...
          <div className="p-3 px-4 border border-white/15 rounded-full w-full flex flex-row gap-2 bg-white/5 focus-within:ring-3 focus-within:ring-blue-500/40 focus-within:border-blue-500">
            <i className="flex justify-center items-center bi bi-person-vcard text-white/50 text-xl"></i>
            <input
              className="focus:outline-0 w-full text-sm sm:text-base font-medium text-white/50 disabled:cursor-not-allowed"
              type="text"
              name="lastname"
          ...
          <div className="w-full">
            ...
            >
              ...
              {showPassword ? (
                <i
                  className="flex justify-center items-center bi bi-eye hover:cursor-pointer text-white/50 hover:text-blue-500 transition text-xl"
                  onClick={handleClick}
                ></i>
              ) : (
                <i
                  className="flex justify-center items-center bi bi-eye-slash hover:cursor-pointer text-white/50 hover:text-blue-500 transition text-xl"
                  onClick={handleClick}
                ></i>
              )}
            </div>
